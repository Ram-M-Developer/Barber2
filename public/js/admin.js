...
function setupAdminSockets() {
  try {
    ...
    adminSocket.on('chair-update', () => {
      console.log('🔄 Sockets Admin: Chair update received.');
      loadTabContent();
    });

    adminSocket.on('queue-update', () => {
      console.log('🔄 Sockets Admin: Queue update received.');
      loadTabContent();
    });

    adminSocket.on('appointment-update', () => {
      console.log('🔄 Sockets Admin: Appointment update received.');
      loadTabContent();
    });
